...
export const Product = motion(forwardRef(({ product, className, ...props }: ProducProps, ref: ForwardedRef<HTMLDivElement>): JSX.Element => {
        ...
        <div className={className} {...props} ref={ref}>
            <Card className={styles.product}>
                ...
                <div className={styles.credit}>
                    ...
                    {priceUa(product.credit)}<span aria-hidden={true}>/</span><span className={styles.month} aria-label="в месяц">мес</span>
                </div>
                ...
                <div className={styles.advBlock}>
                    {product.advantages && <div className={styles.advantages}>
                        <div className={styles.advTitle}>Перимущества</div>
            ...
            <motion.div
                ...
                variants={variants}
                initial="hidden">
                <Card color='blue' className={cn(styles.rewiews)} ref={reviewRef} tabIndex={isReviewOpened ? 0 : -1}>
